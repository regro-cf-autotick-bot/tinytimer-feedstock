About tinytimer-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tinytimer-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6035&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tinytimer-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tinytimer` can be installed with `conda`:
...
```
mamba install tinytimer
```

It is possible to list all of the versions of `tinytimer` available on your platform with `conda`:
...
```
mamba search tinytimer --channel conda-forge
```
...
mamba repoquery search tinytimer --channel conda-forge

# List packages depending on `tinytimer`:
mamba repoquery whoneeds tinytimer --channel conda-forge

# List dependencies of `tinytimer`:
mamba repoquery depends tinytimer --channel conda-forge
```
